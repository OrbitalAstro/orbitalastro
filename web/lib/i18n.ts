...
export const translations = {
  en: {
    ...
    authPasswordReset: {
      ...
      forgotSubtitle:
        "Enter the email associated with your account. If it exists, we will send you a reset link (valid about 1 hour).",
      emailLabel: "Email",
      submit: "Send reset link",
      sending: "Sending…",
      sentMessage:
        "If this address is linked to an account, you will receive an email shortly. Check your spam folder.",
      backSignIn: "Back to sign in",
      resetTitle: "Choose a new password",
      resetSubtitle: "Enter your new password twice, then save.",
      newPasswordLabel: "New password",
      confirmPasswordLabel: "Confirm",
      submitReset: "Update password",
      updating: "Updating…",
      successMessage: "Your password has been updated. You can sign in.",
      goSignIn: "Sign in",
      errorMismatch: "Passwords do not match.",
      errorShort: "At least 8 characters.",
    ...
    nav: {
      ...
      journalPilot: "Journal Pilot",
      valentine: "Relational duo",
      chat: "Chat",
      pricing: "Products",
      univers: "Universe",
      settings: "Settings",
    ...
    settings: {
      ...
      accountPasswordSection: "Account password",
    },
    faq: {
  ...
  fr: {
    ...
    authPasswordReset: {
      ...
      forgotSubtitle:
        "Indique le courriel de ton compte. S’il existe, nous t’enverrons un lien de réinitialisation (environ 1 heure).",
      emailLabel: "Courriel",
      submit: "Envoyer le lien",
      sending: "Envoi…",
      sentMessage:
        "Si cette adresse est liée à un compte, tu recevras un courriel sous peu. Vérifie aussi les indésirables.",
      backSignIn: "Retour à la connexion",
      resetTitle: "Nouveau mot de passe",
      resetSubtitle: "Saisis ton nouveau mot de passe deux fois, puis enregistre.",
      newPasswordLabel: "Nouveau mot de passe",
      confirmPasswordLabel: "Confirmation",
      submitReset: "Mettre à jour le mot de passe",
      updating: "Mise à jour…",
      successMessage: "Ton mot de passe a été mis à jour. Tu peux te connecter.",
      goSignIn: "Se connecter",
      errorMismatch: "Les mots de passe ne correspondent pas.",
      errorShort: "Au moins 8 caractères.",
    ...
    nav: {
      ...
      journalPilot: "Journal pilote",
      valentine: "Duo relationnel",
      pricing: "Produits",
      univers: "Univers",
      settings: "Paramètres",
      about: "À propos",
    ...
    settings: {
      ...
      accountPasswordSection: "Mot de passe du compte",
    },
    faq: {
  ...
  es: {
    ...
    authPasswordReset: {
      ...
      forgotSubtitle:
        "Introduce el correo de tu cuenta. Si existe, te enviaremos un enlace de restablecimiento (aprox. 1 hora).",
      emailLabel: "Correo",
      submit: "Enviar enlace",
      sending: "Enviando…",
      sentMessage:
        "Si esta dirección está vinculada a una cuenta, recibirás un correo en breve. Revisa también spam.",
      backSignIn: "Volver al inicio de sesión",
      resetTitle: "Nueva contraseña",
      resetSubtitle: "Escribe la nueva contraseña dos veces y guarda.",
      newPasswordLabel: "Nueva contraseña",
      confirmPasswordLabel: "Confirmación",
      submitReset: "Actualizar contraseña",
      updating: "Actualizando…",
      successMessage: "Tu contraseña se ha actualizado. Ya puedes iniciar sesión.",
      goSignIn: "Iniciar sesión",
      errorMismatch: "Las contraseñas no coinciden.",
      errorShort: "Al menos 8 caracteres.",
    ...
    nav: {
      ...
      journalPilot: "Diario piloto",
      valentine: "Duo relacional",
      pricing: "Productos",
      univers: "Universo",
    ...
    settings: {
      ...
      accountPasswordSection: "Contraseña de la cuenta",
    },
    faq: {
