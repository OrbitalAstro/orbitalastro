-- Journal pilot schema (Supabase)
-- Execute once in Supabase SQL editor before using /journal-pilot.
...
-- Clavardage journal (historique multi-tours, mémoire côté modèle)
