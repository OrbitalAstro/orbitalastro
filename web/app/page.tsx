          ...
          >
            ...
            <motion.div className="flex justify-center">
              ...
              >
                ...
                >
                  <span className="font-semibold text-cosmic-purple text-sm sm:text-base leading-tight">
                    {t.nav.pricing}
                  </span>
                  <p className="font-body text-cosmic-purple/92 text-[0.7rem] sm:text-xs leading-snug px-2">
                    {t.nav.beginJourney}
                  </p>
                </motion.div>
              </Link>
